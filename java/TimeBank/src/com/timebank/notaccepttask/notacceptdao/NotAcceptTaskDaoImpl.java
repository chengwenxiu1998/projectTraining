...
public class NotAcceptTaskDaoImpl extends BaseDao<NotAccept, Integer>{
	...
	public List<NotAccept> findAllNotAcceptTask(){
		try {
			return super.findByProperty("select new com.timebank.entity.NotAccept(t.tId,u.uNickName,u.uImage,t.uTime,t.tDesc,t.tCoinCount,tag.tagText,t.tState,t.uIdAccept,t.tEndTime,t.tImgUrl,t.tcId)"
