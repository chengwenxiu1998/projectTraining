...
public class FindPhoneTaskUpdatePhone extends AsyncTask<String,Object,com.cwx.timebank.bean.User> {
    ...
    protected User doInBackground(String[] strings) {
        ...
        try {
            ...
            Gson gson = new Gson();
            user = gson.fromJson(res, com.cwx.timebank.bean.User.class);
            if(user!=null){
                Log.e("12哈哈哈哈哈",user.toString());
            }
    ...
    @Override
    protected void onPostExecute(com.cwx.timebank.bean.User user) {

        if(user!=null){//数据库中有该号码
